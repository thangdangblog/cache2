...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const MISALocalStorage = new MISALocalStorageObject();

    const initCode = function () {
        // Kiểm tra xem có thông tin trong LocalStorage không = phương thức Get

        // Lấy dữ liệu
        let dataLocal = MISALocalStorage.get(KEY_INFOR);
    ...
    $(".btn-logout").click(() => {
        ...
        MISALocalStorage.remove(KEY_INFOR);
        
        // hoặc có thể dùng ClearAll để xóa tất cả
        // MISALocalStorage.clearAll();
    ...
    $(".btn-login").click(() => {
        ...
        request.done(function (msg) {
            ...
            if (msg && msg.Success && msg.Data) {
                ...
                MISALocalStorage.set(KEY_INFOR, JSON.stringify(msg.Data));
...
const MISALocalStorageObject = function (prefix = "MISA") {
    ...
    this.set = function (key, value) {
        return window.localStorage.setItem(this.getKey(key), value);
    }
